...
export class LoginComponent implements OnInit ,AfterViewInit {
  ...
  ngOnInit(): void {
    // this._httpService.startService(); To tempory stop due to error message when testing undo after ui is created
    // this._lifeCycleService.hasEnded();
    
  }
  
  public submit_login_form():void  {
    this._httpService.postLogin(this.loginForm).subscribe(
      (data: any) => {
        if (data.success){
  ...
  public submit_register_form():void{
    // To do:// Autenticate with this.registerForm
  
    console.log(this.registerForm.value.dob.getdate());
  };
  ...
  public changeTab(id:string):void{
    ...
    if(id == "login"){
      ...
      document.getElementById("regis")!.style.display = "flex";
    }
    this.selectedTab = id;
  }
}
